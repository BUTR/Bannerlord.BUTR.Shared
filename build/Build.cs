...
class Build : NukeBuild
{
    ...
    Project IsExternalInitProject => Solution.GetProject("Bannerlord.BUTR.Shared");
    ...
    FileInfo NuspecFile => new FileInfo(RootDirectory / "src" / "Bannerlord.BUTR.Shared.nuspec");
